"""CLI command group: logatory export."""
...
def export_report(
    ...
    title: str = typer.Option("Logatory Security Report", "--title", help="Report title."),
    ...
    Examples::
        ...
        logatory export report
        logatory export report --since 24h --severity high --output daily.md
        logatory export report --open
    """
