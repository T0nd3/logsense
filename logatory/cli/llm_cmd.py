...
from logatory.llm.retrieval import build_chroma_index, retrieve_context
...
def llm_summarize(
    ...
    if not rows:
        typer.echo("No errors found. Run 'logatory scan --track-errors' first.")
        return
...
def llm_index(
    ...
    """Build (or rebuild) the ChromaDB embedding index for 'logatory llm ask'.
