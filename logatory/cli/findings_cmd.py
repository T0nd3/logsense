...
from logatory.cli.colors import SEVERITY_COLOR as _SEV_COLOR
...
def findings_list(
    ...
    if not rows:
        typer.echo("No findings stored yet. Run 'logatory scan --track-errors' first.")
        return
...
def findings_dismiss(
    ...
    Examples::
        ...
        logatory findings dismiss SSH_BRUTE_FORCE
